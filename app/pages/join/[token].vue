...
import { Building2, UserPlus, Shield, ShieldCheck, Loader2, AlertTriangle, Check } from '@lucide/vue'
...
useSeoMeta({
  ...
  description: 'Accept an invitation to join an organization on PDS Recruitment Assistant',
...
<template>
  ...
  <div v-else-if="linkInfo" class="flex flex-col gap-5">
    <div class="text-center">
      ...
      <p class="text-sm text-surface-500 dark:text-surface-400">You've been invited to join a team on PDS Recruitment Assistant.</p>
    </div>
