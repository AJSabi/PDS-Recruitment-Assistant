...
<template>
  <div>
    <div class="mb-4 flex flex-wrap items-center gap-2">
      ...
      <NuxtLink :to="localePath(`/dashboard/jobs/${jobId}/pds-ranking`)" class="rounded-lg border border-surface-300 px-3 py-2 text-sm font-semibold text-surface-700 hover:border-brand-400 hover:text-brand-700 dark:border-surface-700 dark:text-surface-300">Candidate Ranking</NuxtLink>
