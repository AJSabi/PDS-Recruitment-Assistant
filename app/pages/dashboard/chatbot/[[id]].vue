      ...
      >
        ...
        <div v-if="messages.length === 0" class="mx-auto flex h-full max-w-3xl flex-col items-center justify-center px-6 py-12 text-center">
          ...
          <p class="mt-2 max-w-md text-sm text-surface-500">
            ...
            PDS Recruitment Assistant has live access to your hiring data.
          </p>
        ...
        <div class="mx-auto w-full max-w-3xl">
          ...
          >
            ...
            <textarea
              ...
              v-model="draft"
              rows="1"
              placeholder="Ask PDS Recruitment Assistant anything…"
          ...
          <p v-else class="mt-2 text-center text-[11px] text-surface-400">
            PDS Recruitment Assistant can make mistakes. Verify candidate-impacting decisions.
          </p>
        </div>
      </div>
    </main>
