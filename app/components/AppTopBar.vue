    ...
    <div class="relative z-20 border-b border-surface-200/80 dark:border-surface-800/80 bg-white/80 dark:bg-surface-900/80 backdrop-blur-xl">
      <div class="flex h-14 items-center justify-between px-4 lg:px-6">
        ...
        <div class="flex items-center gap-1 lg:gap-2">
          ...
          >
            <img src="/eagle-mascot-logo.png" alt="PDS Recruitment Assistant mascot" class="size-7 shrink-0 object-contain" />
            <span class="text-[15px] font-bold text-surface-900 dark:text-surface-100 hidden sm:block tracking-tight">PDS Recruitment Assistant</span>
          </a>
