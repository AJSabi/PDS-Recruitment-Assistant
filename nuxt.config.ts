...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      titleTemplate: "%s — PDS Recruitment Assistant",
      link: [
  ...
  vite: {
    plugins: [tailwindcss()],
    server: {
      // Dev-only: allow the Emergent preview/ingress hostnames through Vite's
      // dev-server host check (leading dot = domain + all subdomains).
