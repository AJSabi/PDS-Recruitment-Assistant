import { z } from 'zod'
import { currentFitSchema, recruitmentStageSchema } from './recruitmentWorkflow'
...
export const CONFIRMED_STAGE_TRANSITIONS: Record<string, string[]> = {
  ...
  reassess: ['resume_reviewed', 'recruiter_screening_pending', 'hod_round_pending', 'hold_for_comparison', 'not_proceeding', 'closed'],
